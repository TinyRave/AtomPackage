...
var BlockScope, Frequency, TinyRave, TinyRaveScheduler,
  __slice = [].slice,
...
TinyRaveScheduler = (function() {
  TinyRaveScheduler.createBlock = function(duration, methods) {
    return {
      duration: duration,
      methods: methods
    };
  ...
  TinyRaveScheduler.prototype.getTime = function() {
    return this.time;
  };

  TinyRaveScheduler.prototype.setTime = function(time) {
  ...
  TinyRaveScheduler.prototype.dequeueNextDescriptor = function() {
  ...
  TinyRaveScheduler.prototype.fireCallbacks = function() {
  ...
  TinyRaveScheduler.prototype.registerCallback = function(callback, interval, registrationTime, isLoop) {
    var id;
  ...
  TinyRaveScheduler.prototype.unregisterCallback = function(id) {
  ...
  TinyRaveScheduler.prototype.getBlockQueueLength = function() {
  ...
  TinyRaveScheduler.prototype.push = function() {
  ...
  TinyRaveScheduler.prototype.shiftBlock = function() {
...
TinyRave.setInterval = function(callback, delay) {
  return TinyRave.scheduler.registerCallback(callback, delay, TinyRave.scheduler.getTime(), true);
};

TinyRave.setTimeout = function(callback, delay) {
  return TinyRave.scheduler.registerCallback(callback, delay, TinyRave.scheduler.getTime(), false);
};
